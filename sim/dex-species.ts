...
type SpeciesTag = "Mythical" | "Restricted Legendary" | "Sub-Legendary" | "Paradox" | "Infinite Fusion" | "Pokeathlon" | "Insurgence";
...
export class Species extends BasicEffect implements Readonly<BasicEffect & SpeciesFormatsData> {
	...
	constructor(data: AnyObject) {
		...
		this.isMega = !!(this.forme && ['Mega', 'Mega-X', 'Mega-Y', 'Mega-M', 'Mega-F'].includes(this.forme)) || undefined;
