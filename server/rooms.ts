...
export class GameRoom extends BasicRoom {
	...
	async uploadReplay(user: User, connection: Connection, options?: 'forpunishment' | 'silent') {
		...
		if (battle.replaySaved) {
			...
			connection.popup(`The replay for this battle was already saved.` + (location ? ` You can find it at http://replay.pokeathlon.com/#replay=${location}&` : ``));
			return;
		}
		...
		connection.popup(`Replay was saved successfully! You can view it at http://replay.pokeathlon.com/#replay=${replayName}&`);
	}
